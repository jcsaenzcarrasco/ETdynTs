...
From the above analyses, we notice that \link performs better when is interleaved with \cut. %Fig.~\ref{fig:EachOpForest} shows the bulk and individual cases in the following charts varying the forest size under the same amount of operations.
