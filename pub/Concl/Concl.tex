...
\tcr{Function \code{search} has the following constraint. A constraint from \code{search} is that of \cite{FTsURL}:}

\begin{displayquote}
A result of \code{search}, attempting to find a point where a predicate on splits of the sequence changes from \code{False} to \code{True}.
